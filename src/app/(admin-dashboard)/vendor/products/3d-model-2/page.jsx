...
// import { HexColorPicker } from 'react-colorful' // Uncomment this if you need the color picker
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <Html position={[0.25, 0.1, 2.75]} scale={0.15} rotation={[Math.PI / 2, 0, 0]} transform>
        <HexColorPicker className="picker" color={color} onChange={setColor} style={{position: 'absolute !important', top: '74px', left: '70px', width: '90px !important', height: '90px !important' }} />
      </Html>
    </group>
  )
}
