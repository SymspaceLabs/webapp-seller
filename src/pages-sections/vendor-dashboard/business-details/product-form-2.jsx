              ...
              <Box>
                ...
                <Grid container spacing={3}>
                  <Grid item sm={6} xs={12}>
                    <TextField select fullWidth color="info" size="medium" name="industry" onBlur={handleBlur} placeholder="Select your industry" onChange={handleChange} value={values.industry} label="Select your industry" SelectProps={{ multiple: false }} error={!!touched.industry && !!errors.industry} helperText={touched.industry && errors.industry}>
